  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="card p-6 text-center">
          <div className="text-3xl font-bold text-creative-600 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="card p-6">
          ...
          <div className="space-y-3">
            <a href="/drawing" className="w-full btn-primary text-left block">
              🎨 Start New Drawing
            </a>
            <a href="/challenges" className="w-full btn-secondary text-left block">
              🏆 Take a Challenge
            </a>
            <a href="/badges" className="w-full btn-outline text-left block">
              🏅 View Badges
            </a>
          </div>
        </div>
          ...
          {user?.achievements?.length > 0 ? (
            <div className="space-y-2">
              {user.achievements.slice(0, 3).map((achievement, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 bg-gradient-to-r from-success-50 to-success-100 rounded-lg">
...
const CanvasTab = () => {
  return (
    <div className="card p-8 text-center">
      ...
      <a href="/drawing" className="btn-primary">
        Launch Canvas
      </a>
    </div>
  );
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <span className="badge badge-primary capitalize">{user?.skillLevel}</span>
              </div>
            </div>
          </div>
